...
`,
			contact: {
				name: "API Support",
				url: "https://github.com/alikuxac/temp-mail",
			},
			license: {
				name: "MIT",
				url: "https://github.com/alikuxac/temp-mail/blob/main/LICENSE",
			},
		},
		servers: [
			{
				url: "https://mail-api.alikuxac.xyz",
		...
		"x-repository": "https://github.com/alikuxac/temp-mail",
		"x-issues": "https://github.com/alikuxac/temp-mail/issues",
	});
